  ...
  -H 'Content-Type: application/json' -d '{
    ...
    "config": {
       "connector.class": "io.debezium.connector.postgresql.PostgresConnector",
          ...
          "value.converter.apicurio.registry.artifact.strategy": "io.apicurio.registry.utils.serde.strategy.RecordIdStrategy",
          "value.converter.apicurio.registry.artifact.resolver.strategy": "io.apicurio.registry.utils.serde.strategy.RecordIdStrategy",
          "value.converter.apicurio.registry.artifactId.strategy": "io.apicurio.registry.utils.serde.strategy.RecordIdStrategy",
          "value.converter.apicurio.registry.artifactResolverStrategy": "io.apicurio.registry.utils.serde.strategy.RecordIdStrategy",
